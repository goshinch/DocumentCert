...
-- insert into `Members` values ( 'admin', 'admin', '12345' );
-- insert into `Authoroties` values ( 'admin', 'ROLE_ADMIN' );

merge into `Members` key (`member_id`) values ( 'admin', 'admin', '12345' );
merge into `Authoroties` key (`member_id`) values ( 'admin', 'ROLE_ADMIN' );

commit;

-- 3. resident 테이블 데이터 추가
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('남길동', '130914-1234561', '남', '1913-09-14 07:22:00', '자택', '경기도 성남시 분당구 대왕판교로645번길', '2021-04-29 09:03:00', '주택', '강원도 고성군 금강산로 290번길');
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('남석환', '540514-1234562', '남', '1954-05-14 17:30:00', '병원', '경기도 성남시 분당구 대왕판교로645번길', null, null, null);
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('박한나', '551022-1234563', '여', '1955-10-22 11:15:00', '병원', '서울특별시 중구 세종대로 110번길', null, null, null);
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('남기준', '790510-1234564', '남', '1979-05-10 20:45:00', '병원', '경기도 성남시 분당구 대왕판교로645번길', null, null, null);
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('이주은', '820821-1234565', '여', '1982-08-21 01:28:00', '병원', '경기도 수원시 팔달구 효원로 1번길', null, null, null);
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('이선미', '851205-1234566', '여', '1985-12-05 22:01:00', '병원', '경기도 수원시 팔달구 효원로 1번길', null, null, null);
INSERT INTO `resident`(
    `name`, `resident_registration_number`, `gender_code`, `birth_date`,
    `birth_place_code`, `registration_base_address`, `death_date`,
    `death_place_code`, `death_place_address`
) VALUES ('남기석', '120315-1234567', '남', '2012-03-15 14:59:00', '병원', '경기도 성남시 분당구 대왕판교로645번길', null, null, null);
...
insert into `certificate_issue` values(9876543210987654, 4, '주민등록등본', '20211024');
